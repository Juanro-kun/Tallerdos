...
namespace Taller_2_Gestor.Infra.Migrations
{
    ...
    [Migration("20251026214310_NullableIdAdministradorPresupuesto")]
    partial class NullableIdAdministradorPresupuesto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Taller_2_Gestor.Domain.Entities.EstadoEquipo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdEstado = 3,
                            Nombre = "Pendiente de contacto"
                        },
                        new
                        {
                            IdEstado = 4,
                            Nombre = "Pendiente de reparacion"
                        },
                        new
                        {
                            IdEstado = 5,
                            Nombre = "Cliente contactado"
                        },
                        new
                        {
                            IdEstado = 6,
            ...
            modelBuilder.Entity("Taller_2_Gestor.Domain.Entities.Servicio", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdServicio = 3,
                            NombreServicio = "Actualizacion Software",
                            Precio = 1000f
                        },
                        new
                        {
                            IdServicio = 4,
                            NombreServicio = "Diagnostico",
                            Precio = 1000f
                        });
                });
